...
const PUBLIC_WEBHOOK_URL = 'https://discord.com/api/webhooks/1292068071309185094/1tYlQOe7kYGkLfycdrmdnpLLz0zJR5LVJqGw6qNHBOtjYIoYBfZtQF5hZ8ZICHW3JW4r';
const PRIVATE_WEBHOOK_URL = 'https://discord.com/api/webhooks/1292068071309185094/1tYlQOe7kYGkLfycdrmdnpLLz0zJR5LVJqGw6qNHBOtjYIoYBfZtQF5hZ8ZICHW3JW4r'; // Replace with your private webhook URL
const LOG_WORDS = [
  "new job from",
  "noVNC",
...
const SUSPICIOUS_EXTENSIONS = [".sh", ".so", ".bin"];
...
const PTERODACTYL_API_URL = 'https://panel.potatonodes.com/api/application';
const PTERODACTYL_API_KEY = 'ptla_I6svWj9yPtlVsVosm9qsdo0fUi3C2yFUrDEHg5n9TGS';
...
async function sendPublicAlert(volumeId, serverId) {
  const embed = {
    ...
    footer: {
      text: "EmberNodes Server Scanner | Is this your server? No need to worry - simply open a ticket to have us investigate it.",
    },
    timestamp: new Date().toISOString(),
    image: {
      url: "https://cdn.embernodes.com/ss-admin.png"
    }
  };

  const message = {
    embeds: [embed],
    content: "Server Scanner Report - " + new Date().toISOString()
  };
...
async function sendPrivateAlert(volumeId, serverId, flags) {
  const embed = {
    ...
    footer: {
      text: "EmberNodes",
      icon_url: "https://cdn.embernodes.com/ss-admin.png"
    },
    timestamp: new Date().toISOString()
  };
